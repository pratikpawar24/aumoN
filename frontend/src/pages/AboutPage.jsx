    ...
    <div className="max-w-3xl mx-auto space-y-10">
      <div className="text-center">
        <h1 className="text-4xl font-bold text-white mb-4">
          About <span className="text-green-400">AUMO</span>
        </h1>
      ...
      <div className="rounded-2xl p-8 border border-white/10 space-y-4"
        ...
        <p className="text-slate-300 leading-relaxed">
          ...
          We use Dijkstra's and A* algorithms with emission-weighted edges:
        </p>
        <div className="rounded-xl p-4 border font-mono text-sm text-green-400"
